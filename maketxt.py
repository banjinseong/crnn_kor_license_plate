...
# 이미지 파일들이 있는 디렉토리 경로
image_directory = './deep-text-recognition-benchmark/plate_data/images'  # 여기에 이미지 파일들이 있는 경로를 입력하세요

# 결과를 저장할 텍스트 파일 경로
output_file_path = './deep-text-recognition-benchmark/plate_data/labels.txt'

# 이미지 파일 목록 가져오기
image_files = [f for f in os.listdir(image_directory) if f.endswith('.png')]

# 텍스트 파일에 기록하기 (cp949 인코딩 사용)
