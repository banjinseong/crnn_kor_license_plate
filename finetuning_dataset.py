...
# Data Preprocessing
with open(f'./kor_dataset/finetuning_data/{data_type}/labels.txt', 'r', encoding='cp949') as f:
    labels = f.readlines()

image_files = os.listdir(f'./kor_dataset/finetuning_data/{data_type}/images/')
